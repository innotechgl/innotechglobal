...
class videoCategoriesModel extends videoGallery_categories_class
{
    ...
    public function getOptions(){
        $fileToLoad = _APP_DIR_."pages/videoGallery_categories/settings/categoryOptions.xml";
    ...
    public function _add(array $data)
    {
        ...
        $query = "INSERT INTO ".$this->table
            ...
            $category->get_parent_id()."', '".$category->get_lang()."', '".$category->get_active()."',
             '".$category->get_alias()."','".$category->get_description()."',
