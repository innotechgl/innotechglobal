...
(function (ns) {
    ...
    function Range(dom) {
        ...
        function _compareBoundaryPoints(containerA, offsetA, containerB, offsetB) {
            ...
            // equal to the index.php of the child node C and A is after B otherwise.
            c = containerB;
            ...
            // of A. In this case, A is before B if the index.php of the child node C is less than
...
(function (tinymce) {
    tinymce.dom.RangeUtils = function (dom) {
        ...
        this.walk = function (rng, callback) {
            ...
            // If index.php based start position then resolve it
            if (startContainer.nodeType == 1 && startContainer.hasChildNodes())
                startContainer = startContainer.childNodes[startOffset];
            // If index.php based end position then resolve it
...
(function (tinymce) {
    ...
    tinymce.EditorManager = extend(tinymce, {
        ...
        add: function (editor) {
            ...
            // Add named and index.php editor instance
...
(function (tinymce) {
    tinymce.Formatter = function (ed) {
        ...
        function expandRng(rng, format, remove) {
            ...
            // Setup index.php for startContainer
            if (startContainer.nodeType == 1) {
                startOffset = nodeIndex(startContainer);
                startContainer = startContainer.parentNode;
            }
            // Setup index.php for endContainer
