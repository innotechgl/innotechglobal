(function (c) {
    var a = /^\s*|\s*$/g, d;
    var b = {
        majorVersion: "3", minorVersion: "3.6", releaseDate: "2010-05-20", _init: function () {
...
(function () {
    ...
    var f = b.selectors = {
        ...
        relative: {
            "+": function (y, e, x) {
                var u = typeof e === "string", z = u && !/\W/.test(e), v = u && !z;
                if (z && !x) {
                    e = e.toUpperCase()
                }
                        ...
                        function k(z) {
                            ...
                            if (t) {
                                ...
                                if (!u) {
                                    x = t.previousSibling;
                                    v = t.nextSibling;
                                    d(c.grep(t.childNodes), function (A) {
                                        if (A.nodeType == 3) {
                                            A.nodeValue = A.nodeValue.replace(/\uFEFF/g, "")
                                        }
                                    });
                                    while (t = l.get(m.id + "_" + z)) {
                                        l.remove(t, 1)
                                    }
                                    if (x && v && x.nodeType == v.nodeType && x.nodeType == 3) {
                                        s = x.nodeValue.length;
                                        x.appendData(v.nodeValue);
                                        l.remove(v);
                                        if (z == "start") {
                                            j = r = x;
                                            n = o = s
...
(function (a) {
    a.create("tinymce.dom.XMLWriter", {
        node: null, XMLWriter: function (c) {
            function b() {
    ...
    e.create("tinymce.dom.Serializer", {
        Serializer: function (j) {
            ...
            if (n.format == "html") {
                l = i._protect({
                    content: j,
                    patterns: [{pattern: /(<script[^>]*>)(.*?)(<\/script>)/g}, {pattern: /(<noscript[^>]*>)(.*?)(<\/noscript>)/g}, {pattern: /(<style[^>]*>)(.*?)(<\/style>)/g}, {
                        pattern: /(<pre[^>]*>)(.*?)(<\/pre>)/g,
                        encode: 1
                    }, {pattern: /(<!--\[CDATA\[)(.*?)(\]\]-->)/g}]
                });
        ...
        function b(m, u) {
            ...
            if (a.isIE6) {
                ...
                if (o.host == r.hostname && o.port == r.port && (o.protocol + ":") == r.protocol) {
                    a.util.XHR.send({
                        url: a._addVer(o.getURI()), success: function (x) {
    ...
    e.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {
        DropMenu: function (h, g) {
            ...
            g = c.create("div", {
                id: "menu_" + i.id,
                "class": j["class"],
                style: "position:absolute;left:0;top:0;z-index.php:200000"
            });
            k = c.add(g, "div", {
                id: "menu_" + i.id + "_co",
...
(function (b) {
    ...
    b.create("tinymce.AddOnManager", {
        items: [], urls: {}, lookup: {}, onAdd: new a(this), get: function (d) {
    ...
    m.create("tinymce.Editor", {
        Editor: function (r, q) {
            ...
            z.formatter.register({
                ...
                bold: [{inline: "strong"}, {inline: "span", styles: {fontWeight: "bold"}}, {inline: "b"}],
                italic: [{inline: "em"}, {inline: "span", styles: {fontStyle: "italic"}}, {inline: "i"}],
                underline: [{inline: "span", styles: {textDecoration: "underline"}, exact: true}, {inline: "u"}],
                strikethrough: [{inline: "span", styles: {textDecoration: "line-through"}, exact: true}, {inline: "u"}],
            ...
            i("p h1 h2 h3 h4 h5 h6 div address pre div code dt dd samp".split(/\s/), function (s) {
                z.formatter.register(s, {block: s, remove: "all"})
            });
            ...
            this.execCommands[r] = {func: q, scope: p || this}
        }, addQueryStateHandler: function (r, q, p) {
            this.queryStateCommands[r] = {func: q, scope: p || this}
        }, addQueryValueHandler: function (r, q, p) {
            this.queryValueCommands[r] = {func: q, scope: p || this}
            ...
            v.onReset.add(function () {
                v.setContent(v.startContent, {format: "raw"})
            });
    ...
    c.EditorCommands = function (n) {
        ...
        t({
            "mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                p.setContent(u.replace(/\{\$selection\}/g, p.getContent({format: "text"})))
...
(function (b) {
    ...
    b.UndoManager = function (e) {
        ...
        return c = {
            typing: 0, onAdd: new a(c), onUndo: new a(c), onRedo: new a(c), add: function (l) {
...
(function (a) {
    function b() {
        ...
        function f(j, i, h, g) {
            ...
            a.each(i, function (k) {
                j[k.toLowerCase()] = {func: h, scope: g}
            })
        }
...
(function (a) {
    a.Formatter = function (T) {
        ...
        function z(W, ae, Y) {
            ...
            function ab(ak) {
                var aj = c.get(ak ? "_start" : "_end"), ai = aj[ak ? "firstChild" : "lastChild"];
                if (G(ai)) {
            ...
            function ah(ai) {
                ...
                if (ag.split) {
                    ...
                    ak = H(ai);
                    if (aj != ak) {
                        aj = L(aj, "span", {id: "_start", _mce_type: "bookmark"});
                        ak = L(ak, "span", {id: "_end", _mce_type: "bookmark"});
                        af(aj);
                        af(ak);
                        aj = ab(A);
                        ak = ab()
...
tinymce.onAddEditor.add(function (e, a) {
    ...
    if (c.inline_styles) {
        ...
        function b(j, i) {
            g.replace(g.create("span", {style: i}), j, 1)
        }
